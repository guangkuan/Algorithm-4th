...
public class DijkstraSP {
    ...
    public DijkstraSP(EdgeWeightedDigraph G, int s) 
    {
        ...
        {
            int v = pq.delMin();
            StdOut.printf("erase %d from priority_queue, ", v);
            if(edgeTo[v] != null)
            	StdOut.printf("add %d -> %d to the tree, ", edgeTo[v].from(), edgeTo[v].to());
    ...
    private void relax(DirectedEdge e) 
    {
        ...
        if (distTo[w] > distTo[v] + e.weight()) 
        {
            ...
            else  
            {
            	...
            	StdOut.printf("add %d to priority, ", w);
            }   	
        }
        else
        {
        	StdOut.printf("%d -> %d is invalid, ", v, w);
        }
    }
